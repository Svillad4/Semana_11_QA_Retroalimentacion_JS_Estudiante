...
document.getElementById('registro-form').addEventListener('submit', manejarEnvio);
document.getElementById('btn-reset').addEventListener('click', limpiarFormulario);
